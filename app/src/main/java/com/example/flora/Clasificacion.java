...
public class Clasificacion extends AppCompatActivity {
 ...
 private  EditText edtCodigo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNombreCientifico.setText(nombre);
    }
    ...
    public void registrarClasificacion(View view){
        if (isValidarCampos()){
           ...
           datos1.put("especie", especie);
            ...
            AndroidNetworking.post("https://secret-crag-59155.herokuapp.com/ClasificacionTaxonomica_INSERTAR_POST.php").setPriority(Priority.MEDIUM).addJSONObjectBody(jsonData1)
